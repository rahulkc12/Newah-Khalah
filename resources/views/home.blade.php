...
<!-- Newsletter Section -->
<div style="background-image: url('img/background.svg');" class="bg-cover bg-center py-16 px-4 md:px-20 lg:px-48 space-y-8">
    <div class="text-center">
        <h2 class="text-2xl text-red-900 font-semibold mb-2">Stay Connected</h2>
        <p class="text-base text-gray-800 font-regular mb-4">Don’t Miss an Update</p>
        <p class="text-lg text-gray-800 font-regular leading-relaxed max-w-2xl mx-auto">
